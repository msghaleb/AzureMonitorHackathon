...
- Simulate a CPU load on the VM Scale Set using the [cpuGenLoadwithPS.ps1](../sources/Loadscripts/cpuGenLoadwithPS.ps1)
...
![enter image description here](../images/ch1_metric_spike.jpg)
